...
function VueloStatusPage() {
  ...
  const vuelosFiltrados = vuelosToFilter.filter((vuelo) => {
    const matchEstado =
      filtroEstado === "Todos" || vuelo.estado === filtroEstado;
    const matchDestino =
      filtroDestino === "" ||
      (vuelo.destino &&
    ...
    return matchEstado && matchDestino && matchFechaLlegada;
  });
                ...
                >
                  ...
                  <p className="text-gray-700 text-sm mb-1">
                    ...
                    <span className="font-medium">
                      {formatDateTime(vuelo.fechaSalida)}
                    </span>
                  </p>
                  <p className="text-gray-700 text-sm mb-2">
                    Llegada:{" "}
                    <span className="font-medium">
                      {formatDateTime(vuelo.fechaLlegada)}
                    </span>
                  </p>
